...
function Home() {
    // useEffect(() => {
    //     // fetch(`https://course.spacedev.vn/elearning/v4/courses`)
    //     //     .then((res) => res.json())
    //     //     .then((res) => setCourses(res.data));
    //     // api.get(`/elearning/v4/courses`).then((res) => {
    //     //     setCourses(res.data.data);
    //     // });
    //     // giá trị trả về = api.interceptors.response (file api)
    ...
    const { data, loading } = useQuery(() => courseService.getList(), []);
            ...
            <section className="section-courseoffline">
                <div className="container">
                    ...
                    <div className="list row">
                        {loading ? <p>đang tải dữ liệu</p> : data.map((e) => <Course {...e} key={e.id} />)}
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        ...
                        <div className="contentbox col-md-6 col-sm-12 col-xs-12">
                            <div className="item">
                                ...
                                <p>
                                    Với CFD thì việc cam kết đầu ra nó sẽ không có ý nghĩa nếu như cả người hướng dẫn và
                                    người học không thật sự tâm huyết và cố gắng. Vì thế, đội ngũ CFD sẽ làm hết sức để
                                    giúp các thành viên tạo ra sản phẩm có giá trị, thay vì cam kết.
                                </p>
                            </div>
                            <div className="item">
                                <h4>Không chỉ là một lớp học</h4>
                                <p>
                                    CFD không phải một lớp học thuần túy, tất cả thành viên là một team, cùng hổ trợ,
                                    chia sẻ và giúp đỡ nhau trong suốt quá trình học và sau này, với sự hướng dẫn tận
                                    tâm của các thành viên đồng sáng lập.
                                </p>
                            </div>
                            <div className="item">
                                <h4>Không để ai bị bỏ lại phía sau</h4>
                                <p>
                                    Vì chúng ta là một team, những thành viên tiếp thu chậm sẽ được đội ngũ CFD kèm cặp
                                    đặc biệt, cùng sự hổ trợ từ các thành viên khác. Vì mục tiêu cuối cùng là hoàn thành
                                    khóa học thật tốt.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="text">
                                    <div className="ct ct-1 active">
                                        ...
                                        <div className="content">
                                            ...
                                            qua khóa học. Like cho 4 mentor.
                                        </div>
                                    ...
                                    <div className="ct ct-2">
                                        ...
                                        <div className="content">
                                            ...
                                            interdum dolor in, molestie lectus. Aenean porttitor purus at purus euismod
                                            tristique
                                        </div>
                                        <div className="bottom">
                                            <a href="#" target="_blank">
